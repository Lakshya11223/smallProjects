         ...
         <div className='min-h-screen flex items-center justify-center bg-black text-white px-4'>
            <div className='w-full max-w-md border-2 border-white rounded-2xl p-8 shadow-lg bg-gray-900'>
                ...
                <form className='space-y-6' onSubmit={handleRegister}>
                    ...
                    <p className='text-sm text-center mt-1 ' onClick={() => router.push("/login")}>Already have an account ? <span className='text-blue-400 hover:underline cursor-pointer text-lg'>login</span></p>

                    <button type='button' className='w-full py-2 px-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 cursor-pointer transition-colors'>Register</button>
                </form>
